...
/// A student's assigned puzzles, with a one-click "mark as done" submit.
/// Shared by the student dashboard (a quick glance) and the dedicated
/// /app/puzzles page (its own nav destination).
export function AssignedPuzzlesPanel({ showHeading = true }: { showHeading?: boolean }) {
